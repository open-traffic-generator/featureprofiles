...
type Metadata_Deviations struct {
	...
	BmpOcUnsupported bool `protobuf:"varint,351,opt,name=bmp_oc_unsupported,json=bmpOcUnsupported,proto3" json:"bmp_oc_unsupported,omitempty"`
	...
	SyslogNonDefaultVrfUnsupported bool `protobuf:"varint,352,opt,name=syslog_non_default_vrf_unsupported,json=syslogNonDefaultVrfUnsupported,proto3" json:"syslog_non_default_vrf_unsupported,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
