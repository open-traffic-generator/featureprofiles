...
const (
	...
	Metadata_TESTBED_ATE_DUT_4LINKS_DUT_ATE Metadata_Testbed = 18
)
...
var (
	Metadata_Testbed_name = map[int32]string{
		...
		18: "TESTBED_ATE_DUT_4LINKS_DUT_ATE",
	}
	Metadata_Testbed_value = map[string]int32{
		...
		"TESTBED_ATE_DUT_4LINKS_DUT_ATE": 18,
	}
)
...
type Metadata_Deviations struct {
	...
	IpsecOcUnsupported bool `protobuf:"varint,428,opt,name=ipsec_oc_unsupported,json=ipsecOcUnsupported,proto3" json:"ipsec_oc_unsupported,omitempty"`
	// https://partnerissuetracker.corp.google.com/issues/536063386
	StaticRouteInVrfOcUnsupported bool `protobuf:"varint,429,opt,name=static_route_in_vrf_oc_unsupported,json=staticRouteInVrfOcUnsupported,proto3" json:"static_route_in_vrf_oc_unsupported,omitempty"`
	// https://partnerissuetracker.corp.google.com/issues/536063387
	IpRoutingInVrfOcUnsupported bool `protobuf:"varint,430,opt,name=ip_routing_in_vrf_oc_unsupported,json=ipRoutingInVrfOcUnsupported,proto3" json:"ip_routing_in_vrf_oc_unsupported,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *Metadata_Deviations) GetRequireTransportSecurity() bool {
	if x != nil {
		return x.RequireTransportSecurity
	}
	return false
}
...
func (x *Metadata_Deviations) GetStaticRouteInVrfOcUnsupported() bool {
	if x != nil {
		return x.StaticRouteInVrfOcUnsupported
	}
	return false
}

func (x *Metadata_Deviations) GetIpRoutingInVrfOcUnsupported() bool {
	if x != nil {
		return x.IpRoutingInVrfOcUnsupported
	}
	return false
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xf7\xf0\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x9f\xe6\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"\x1arequire_transport_security\x18\xab\x03 \x01(\bR\x18requireTransportSecurity\x121\n" +
	"\x14ipsec_oc_unsupported\x18\xac\x03 \x01(\bR\x12ipsecOcUnsupported\x12J\n" +
	"\"static_route_in_vrf_oc_unsupported\x18\xad\x03 \x01(\bR\x1dstaticRouteInVrfOcUnsupported\x12F\n" +
	" ip_routing_in_vrf_oc_unsupported\x18\xae\x03 \x01(\bR\x1bipRoutingInVrfOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
	...
	"\x1aTESTBED_DUT_ATE_8LINKS_LAG\x10\x11\x12\"\n" +
	"\x1eTESTBED_ATE_DUT_4LINKS_DUT_ATE\x10\x12\"m\n" +
	"\x04Tags\x12\x14\n" +
