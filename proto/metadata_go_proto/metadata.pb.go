...
type Metadata_Deviations struct {
	...
	MplsStaticPseudowireOcUnsupported bool `protobuf:"varint,418,opt,name=mpls_static_pseudowire_oc_unsupported,json=mplsStaticPseudowireOcUnsupported,proto3" json:"mpls_static_pseudowire_oc_unsupported,omitempty"`
	// Arista: b/495549829
	// Devices that do not support vlan client encapsulation OC
	VlanClientEncapsulationOcUnsupported bool `protobuf:"varint,419,opt,name=vlan_client_encapsulation_oc_unsupported,json=vlanClientEncapsulationOcUnsupported,proto3" json:"vlan_client_encapsulation_oc_unsupported,omitempty"`
	...
	NexthopGroupPseudowireCountersOcUnsupported bool `protobuf:"varint,420,opt,name=nexthop_group_pseudowire_counters_oc_unsupported,json=nexthopGroupPseudowireCountersOcUnsupported,proto3" json:"nexthop_group_pseudowire_counters_oc_unsupported,omitempty"`
	unknownFields                               protoimpl.UnknownFields
	sizeCache                                   protoimpl.SizeCache
}
...
const file_metadata_proto_rawDesc = "" +
	"\n" +
	"\x0emetadata.proto\x12\x12openconfig.testing\x1a1github.com/openconfig/ondatra/proto/testbed.proto\"\xc6\xea\x01\n" +
	"\bMetadata\x12\x12\n" +
	...
	"\x16software_version_regex\x18\x04 \x01(\tR\x14softwareVersionRegexJ\x04\b\x02\x10\x03R\x0ehardware_model\x1a\x92\xe0\x01\n" +
	"\n" +
	"Deviations\x120\n" +
	...
	"8secondary_controller_card_memory_utilization_unsupported\x18\xa1\x03 \x01(\bR3secondaryControllerCardMemoryUtilizationUnsupported\x12Q\n" +
	"%mpls_static_pseudowire_oc_unsupported\x18\xa2\x03 \x01(\bR!mplsStaticPseudowireOcUnsupported\x12W\n" +
	"(vlan_client_encapsulation_oc_unsupported\x18\xa3\x03 \x01(\bR$vlanClientEncapsulationOcUnsupported\x12f\n" +
	"0nexthop_group_pseudowire_counters_oc_unsupported\x18\xa4\x03 \x01(\bR+nexthopGroupPseudowireCountersOcUnsupportedJ\x04\bT\x10UJ\x04\b\t\x10\n" +
