...
replace github.com/openconfig/ondatra => github.com/open-traffic-generator/ondatra v0.0.0-20220420063023-5559ee9d24b5
...
require (
	...
	github.com/openconfig/ondatra v0.0.0-20220504185232-2b3a55f47082
