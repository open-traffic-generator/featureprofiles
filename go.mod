...
require (
	...
	github.com/open-traffic-generator/snappi/gosnappi v0.13.1-0.20231017065451-8e7f655b9a77
	...
	github.com/openconfig/replayer v0.0.0-20231013211236-af5e8d0821fb
